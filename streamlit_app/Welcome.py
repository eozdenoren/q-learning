"""Home/Introduction page for Q-Learning demo multipage Streamlit app."""
...
Head over to the **Dog & Bone Example** tab to watch Luna learn.
...
Head to the **Algorithmic Pricing** tab to find out.
    """
)
